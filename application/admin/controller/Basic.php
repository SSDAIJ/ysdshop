...
class Basic extends AdminBase
{
    ...
    public function share()
    {
        $config = [
            ...
            'app' => ConfigServer::get('share', 'app', [
                'app_share_title' => '',
                'app_share_intro' => '',
                'app_share_image' => ''
            ])
    ...
    public function setShare()
    {
        ...
        $app = json_encode([
            'app_share_title' => $post['app_share_title'],
            'app_share_intro' => $post['app_share_intro'],
            'app_share_image' => $post['app_share_image'],
        ], JSON_UNESCAPED_UNICODE);
        ConfigServer::set('share', 'h5', $h5);
        ConfigServer::set('share', 'mnp', $mnp);
        ConfigServer::set('share', 'app', $app);
        $this->_success('修改成功');
    }
}